...
import { schoolGradesItems } from "./data";
import DataDetailControl from "../../../components/controls/DataDetailControl";

export default SchoolGrades = ({ onTapBack, items, navigation }) => {
    ...
    return (
      <View style={cardStyle.card}>
        <View style={{ flex: 1 }}>
          ...
          /> */}
          <Badge
            status={getColorStatusClass(task.estaAprobada)}
            value={getTextStatusClass(task.estaAprobada)}
            containerStyle={{ position: "relative", width: 65 }}
          />
        </View>
